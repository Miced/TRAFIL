...
public class TclDesignerPanel extends JPanel {
	...
	addMouseListener(new MouseAdapter() {
		...
		if (trafil.getNewWiredNodeButton().isSelected() || trafil.getNewWirelessNodeButton().isSelected()) {
