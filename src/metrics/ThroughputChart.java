...
public class ThroughputChart extends Chart {
     ...
     */
    public ThroughputChart(int startNode, int endNode, String level, int sampleRate, MetaDataHandler metaHandler, TraceFileInfo traceFile, String lineTitle) {
        try {
            int packetNumber = 0;
            double throughput;
            double currentTime;
     ...
     * @param lineTitle what title the new line has (optional)
     */
    public ThroughputChart(int startNode, String level, int sampleRate, MetaDataHandler metaHandler, TraceFileInfo traceFile, String lineTitle) {
        try {
            int packetNumber = 0;
            double throughput;
            double currentTime;
