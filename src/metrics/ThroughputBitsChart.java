...
public class ThroughputBitsChart extends Chart {
     ...
     */
    public ThroughputBitsChart(int startNode, int endNode, String level, int sampleRate, MetaDataHandler metaHandler, TraceFileInfo traceFile, String lineTitle) {
        try {
     ...
     * @param lineTitle what title the new line has (optional)
     */
    public ThroughputBitsChart(int startNode, String level, int sampleRate, MetaDataHandler metaHandler, TraceFileInfo traceFile, String lineTitle) {
        try {
            if (lineTitle.isEmpty()) {
                series = new XYSeries("Throughput(bits/sec)");
            } else {
