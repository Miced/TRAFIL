...
public class PacketEndToEndDelayChart extends Chart {
     ...
     */
    public PacketEndToEndDelayChart(int startNode, int endNode, String level, int sampleRate, MetaDataHandler metaHandler, TraceFileInfo traceFile, String lineTitle) {
        try {
            ...
            if (chartTitle == null || chartTitle.isEmpty()) {
                ...
                chart.setTitle(new org.jfree.chart.title.TextTitle(chartTitle, new java.awt.Font("SansSerif", java.awt.Font.BOLD, 16)));
            }
     ...
     * @param lineTitle what title the new line has (optional)
     */
    public PacketEndToEndDelayChart(int startNode, String level, int sampleRate, MetaDataHandler metaHandler, TraceFileInfo traceFile, String lineTitle) {
        try {
            if (lineTitle.isEmpty()) {
                series = new XYSeries("End to End Delay");
            } else {
