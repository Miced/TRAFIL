...
public class DelayJitterChart extends Chart {
     ...
     */
    public DelayJitterChart(int startNode, int endNode, String level, int sampleRate, MetaDataHandler metaHandler, TraceFileInfo traceFile, String lineTitle) {
...
//
     ...
     * @param lineTitle what title the new line has (optional)
     */
    public DelayJitterChart(int startNode, String level, int sampleRate, MetaDataHandler metaHandler, TraceFileInfo traceFile, String lineTitle) {
        ArrayList<Double> endToEndDelay = new ArrayList();
        Double currentTime;
        Double delayJitter = 0.0;
        if (lineTitle.isEmpty()) {
